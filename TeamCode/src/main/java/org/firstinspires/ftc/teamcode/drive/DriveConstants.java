...
public class DriveConstants {
     ...
     * Set this flag t o false if drive encoders are not present and an alternative localization
     ...
     * empirically tuned.
     */
    public static double kV = .01559604;
    public static double kA = .001;
    public static double kStatic = .07265;
    ...
    public static double MAX_ANG_VEL = Math.toRadians(197);
